...
export function printOwnershipConsoleSignature() {
  ...
  browserConsole.info(
    `%cMERCHAN.DEV  ×  EPRESSIVO VENEZUELA, C.A.`,
    'color:#ffffff;font:800 14px/1.5 ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace;letter-spacing:.06em'
  )
  browserConsole.info(
    `%c${ownershipNotice}`,
    'color:#94a3b8;font:12px/1.65 ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace',
  )
}
